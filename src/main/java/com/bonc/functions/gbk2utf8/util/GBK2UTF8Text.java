 ...
 * @date 2016年8月16日
 */
public class GBK2UTF8Text extends Text{
	
	public static String DECODE_NAME = "GBK";
	   ...
	   */
	  public GBK2UTF8Text(String string) {
	    set(string);
	  }

	  /** Construct from another text. */
	  public GBK2UTF8Text(Text utf8) {
	    set(utf8);
	  }

	  /** Construct from a byte array.
	   */
	  public GBK2UTF8Text(byte[] utf8)  {
	    set(utf8);
	  }
